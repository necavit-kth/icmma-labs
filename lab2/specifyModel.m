...
walk_data_rd = [ASC,age];
walk_name_rd = {'walk_ASC','walk_age'};
bike_data_rd = [ASC,age];
bike_name_rd = {'bike_ASC','bike_age'};
car_data_rd = [age];
car_name_rd = {'car_age'};
PT_data_rd = [ASC,male,age];
PT_name_rd = {'PT_ASC','PT_male','PT_age'};
