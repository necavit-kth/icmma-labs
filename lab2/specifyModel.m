...
walk_data_rd = [ASC,male,age];
walk_name_rd = {'walk_ASC','walk_male','walk_age'};
bike_data_rd = [ASC,male,age];
bike_name_rd = {'bike_ASC','bike_male','bike_age'};
car_data_rd = [carcost,cartime,male,age];
car_name_rd = {'car_cost','car_time','car_male','car_age'};
PT_data_rd = [PTtime,PTcost,ASC,male,age];
PT_name_rd = {'PT_time','PT_cost','PT_ASC','PT_male','PT_age'};
